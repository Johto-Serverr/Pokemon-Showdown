...
var cmds = {
	...
	poll: function (target, room, user) {
		...
		room.addRaw('<div class="infobox"><h2>' + tour[room.id].question + separacion + '<font color="green"><b>To vote, write </b></font><font color="red"><b>/vote OPTION or click the button</b></font></h2><hr />' + list + '</div>');
	},
